...
class ResConfigSettings(models.TransientModel):
    ...
    app_system_name = fields.Char('System Name', help="Setup System Name,which replace Thrive",
                                  default='thriveAi', config_parameter='app_system_name')
    ...
    app_show_share = fields.Boolean('Show Share Dashboard', help="Uncheck to hide the Thrive Share Dashboard",
                                    config_parameter='app_show_share')
    app_show_poweredby = fields.Boolean('Show Powered by Thrive', help="Uncheck to hide the Powered by text",
    ...
    module_thrive_referral = fields.Boolean('Show Thrive Referral', help="Uncheck to remove the Thrive Referral")
    ...
    app_account_title = fields.Char('My Thrive.com Account Title', config_parameter='app_account_title')
    app_account_url = fields.Char('My Thrive.com Account Url', config_parameter='app_account_url')
    ...
    app_debug_only_admin = fields.Boolean('Debug for Admin', config_parameter='app_debug_only_admin',
                                          help="Check to only Debug / Debug Assets for Thrive Admin. Deny debug from url for other user.")
    app_stop_subscribe = fields.Boolean('Stop Thrive Subscribe', help="Check to stop subscribe and follow. This to make thrive speed up.",
                                        config_parameter='app_stop_subscribe')
    # 处理额外模块
    module_app_thrive_doc = fields.Boolean("Help Document Anywhere", help='Get Help Documentation on current thrive operation or topic.')
    module_app_chatgpt = fields.Boolean("Ai Center", help='Use Ai to boost you business.')
    
    # 应用帮助文档
    app_doc_root_url = fields.Char('Help of topic domain', config_parameter='app_doc_root_url', default='https://thriveai.cn')

    @api.model
    def set_module_url(self, rec=None):
        config_parameter = self.env['ir.config_parameter'].sudo()
        app_enterprise_url = config_parameter.get_param('app_enterprise_url', 'https://www.thriveai.cn')
