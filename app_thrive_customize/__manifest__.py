...
{
    'name': 'thrive Tweak,Boost,Customize,Ai All in One. Customize,UI,Boost,Security,Data,Development Enhance',
    'version': '16.23.08.28',
    'author': 'thriveai.cn',
    'category': 'Extra Tools',
    'website': 'https://www.thriveai.cn',
    'live_test_url': 'https://demo.thriveapp.cn',
    'license': 'LGPL-3',
    'sequence': 2,
    'images': ['static/description/banner.gif'],
    'summary': """
    1 click Tweak thrive. 45 Functions thrive enhancement. for Customize, UI, Boost, Security, Development.
    Easy reset data, clear data, reset account chart, reset Demo data.
    For quick debug. Set brand,  Language Switcher. thrive improve all.
    """,
    'depends': [
        'app_common',
        'base_setup',
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'app_thrive_customize/static/src/webclient/*.xml',
    ...
    App Customize Thrive (Change Title,Language,Documentation,Quick Debug)
    ============
    White label thrive.
    Support thrive 16,15,14,13,12,11,10,9.
    You can config thrive, make it look like your own platform.
    1. Deletes Thrive label in footer
    2. Replaces "Thrive" in Windows title
    ...
    13. Change Powered by Thrive in login screen.(Please change '../views/app_thrive_customize_view.xml' #15)
    ...
    17. Stop Thrive Auto Subscribe(Moved to app_thrive_boost)
    ...
    24. Customize Thrive Native Module(eg. Enterprise) Url
    ...
    31. Show or hide thrive Referral in the top menu.
    32. Fix thrive bug of complete name bug of product category and stock location..
    33. Add Demo Ribbon Setting.
    34. Add Remove all quality data.
    35. Fixed for thrive 14.
    ...
    41. Fix thrive bug, when click Preferences menu not hide in mobile.
    42. Mobile Enhance. Add menu navbar setup for top or bottom. navigator footer support.
    43. Check to only Debug / Debug Assets for Thrive Admin. Deny debug from url for other user.
    44. Check to stop subscribe and follow. This to make thrive speed up.
    45. Add addons path info to module.
    46. Add Help documentation anywhere.  easy get help for any thrive operation or action.

    This module can help to white label the Thrive.
    Also helpful for training and support for your thrive end-user.
    The user can get the help document just by one click.
    ## 在符合thrive开源协议的前提下，自定义你的thrive系统
    可完全自行设置下列选项，将 thrive 整合进自有软件产品
    支持thrive 16,15,14,13,12, 11, 10, 9 版本，社区版企业版通用
    1. 删除菜单导航页脚的 Thrive 标签
    2. 将弹出窗口中 "Thrive" 设置为自定义名称
    ...
    12. 多语言版本
    13. 自定义登陆界面中的 Powered by Thrive
    ...
    45. 为应用模块增加模块路径信息
    46. 增加快速帮助文档，可以在任意操作中获取相关的 thrive 帮助.
    """,
}
