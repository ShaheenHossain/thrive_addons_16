...
# Thrive16在线用户手册（长期更新）
# https://www.thriveai.cn/documentation/16.0/zh_CN/index.html

# Thrive16在线开发者手册（长期更新）
# https://www.thriveai.cn/documentation/16.0/zh_CN/developer.html

# Thrive13在线用户手册（长期更新）
# https://www.thriveai.cn/documentation/user/13.0/zh_CN/index.html

# Thrive13在线开发者手册（长期更新）
# https://www.thriveai.cn/documentation/13.0/index.html
...
##############################################################################
#    Copyright (C) 2009-TODAY thriveAi.cn Ltd. https://www.thriveai.cn
...
{
    'name': "thrive User Doc,Developer Doc Anywhere.My document. thrive用户手册，开发手册大全",
    'version': '16.23.08.28',
    'author': 'thriveai.cn',
    'category': 'Base',
    ...
    'summary': '''
    thrive User Documentation and thrive Developer documentation of thrive.
    1 Click to access help of current topic. Add thrive doc local. Documentation with your company name and logo.
    Mrp doc, Sale doc, purchase doc, stock doc, account doc all in one.
    ''',
    'description': '''    
    Support Thrive 16,15,14,13,12, Enterprise and Community and thrive.sh Edition
    1. User Documentation and Developer documentation of thrive.
    ...
    12. Support Thrive 16,15,14,13,12, Enterprise and Community and thrive.sh Edition.
    13. Full Open Source.
    ==========
    1. thrive 的用户文档和开发人员文档。
    2. 一键点击即可访问当前主题、当前操作、当前菜单的帮助。
    3. 附有您公司的名称和Logo的文档。
    4. 集生产制造文档、销售管理文档、采购管理文档、库存管理文档和财务管理文档于一体。
    11. 多语言支持，多公司支持
    12. Thrive 16,15,14,13,12, 企业版，社区版，在线SaaS.sh版，等全版本支持
    13. 代码完全开源
    ''',
    'data': [
        # 'security/*.xml',
